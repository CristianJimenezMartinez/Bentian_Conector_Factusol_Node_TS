...
exports.generateHTMLHome = generateHTMLHome;
exports.generateHTMLConfiguration = generateHTMLConfiguration;
exports.formHTMLConfiguration = formHTMLConfiguration;
exports.buttonLogic = buttonLogic;
const styles_1 = require("./styles");
function generateHTMLHome() {
    const htmlContent = `
    <!DOCTYPE html>
    <html lang="es">
    <head>
      ...
      <style>${styles_1.cssStyles}</style>
    </head>
    <body>
      <div class="container">
        <div class="sidebar">
...
function generateHTMLConfiguration() {
...
function formHTMLConfiguration(configFilePath) {
    const htmlContent = `
    <html lang="es">
    <head>
      <meta charset="UTF-8">
